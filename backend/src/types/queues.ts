...
export enum EmailDomainProfileEventType {
  PROFILE_DOMAIN = 'profileDomain',
}

export interface EmailDomainProfileEvent {
  type: EmailDomainProfileEventType
  domain: string
  forceRefresh?: boolean
...
export enum EmailCandidateVerifyEventType {
  VERIFY_LEAD_EMAIL = 'verifyLeadEmail',
}

export interface EmailCandidateVerifyEvent {
  type: EmailCandidateVerifyEventType
  organizationId: string
  leadId?: string | null
  domain: string
...
export enum EmailVerifyRetryEventType {
  RETRY_EMAIL_VERIFICATION = 'retryEmailVerification',
}

export interface EmailVerifyRetryEvent {
  type: EmailVerifyRetryEventType
