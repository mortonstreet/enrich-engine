...
export const sendEnrichmentCompletedEmail = async ({
  email,
  listName,
  enrichmentType,
  totalRows,
              ...
              <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                <tr>
                  <td style="padding: 48px 40px; text-align: center;">
                    ...
                    <p style="margin: 0 0 32px 0; font-size: 16px; line-height: 1.6; color: #666;">
                      Your ${enrichmentLabel.toLowerCase()} enrichment for <strong>${listName}</strong> has finished processing.
                    </p>
                    <table role="presentation" style="margin: 0 auto; text-align: left; border-collapse: collapse;">
                      <tr>
                        <td style="padding: 12px 24px; border-bottom: 1px solid #e5e5e5;">
                          <span style="color: #999; font-size: 14px;">Total Rows</span><br>
                          <span style="color: #171717; font-size: 18px; font-weight: 600;">${totalRows.toLocaleString()}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 12px 24px; border-bottom: 1px solid #e5e5e5;">
                          <span style="color: #999; font-size: 14px;">Successfully Enriched</span><br>
                          <span style="color: #22c55e; font-size: 18px; font-weight: 600;">${successCount.toLocaleString()}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 12px 24px; border-bottom: 1px solid #e5e5e5;">
                          <span style="color: #999; font-size: 14px;">Not Found</span><br>
                          <span style="color: #ef4444; font-size: 18px; font-weight: 600;">${errorCount.toLocaleString()}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 12px 24px;">
                          <span style="color: #999; font-size: 14px;">Success Rate</span><br>
                          <span style="color: #171717; font-size: 18px; font-weight: 600;">${successRate}%</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding: 24px 40px; background-color: #f9f9fa; border-radius: 0 0 12px 12px; border-top: 1px solid #e5e5e5;">
                    <p style="margin: 0; font-size: 13px; line-height: 1.5; color: #999; text-align: center;">
                      Log in to your dashboard to view and export your enriched data.
                    </p>
                  </td>
                </tr>
              </table>
