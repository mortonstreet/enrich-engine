...
// === Research Connection Types ===

export const ResearchConnectionProviderSchema = z.enum(['firecrawl', 'crawl4ai']);
export type ResearchConnectionProvider = z.infer<typeof ResearchConnectionProviderSchema>;

export const TestFirecrawlConnectionRequestSchema = z.object({
  provider: ResearchConnectionProviderSchema.optional().default('firecrawl'),
...
export interface FirecrawlTestResult {
  success: boolean;
  message: string;
  provider?: ResearchConnectionProvider;
}
