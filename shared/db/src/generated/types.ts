...
export type EmailDomainProfile = {
  id: string
  domain: string
  mxHosts: Generated<string[]>
  mxPresent: Generated<boolean>
  smtpReachable: Generated<boolean>
  catchAllState: Generated<string>
  lastProfiledAt: Timestamp | null
  profileExpiresAt: Timestamp
  sampleSize: Generated<number>
  acceptRate: Generated<string>
  tempFailRate: Generated<string>
  hardRejectRate: Generated<string>
  createdAt: Generated<Timestamp>
  updatedAt: Generated<Timestamp>
}
export type EmailPatternStats = {
  id: string
  domain: string
  pattern: string
...
export type LeadContactInfo = {
  ...
  verificationLastCheckedAt: Timestamp | null
