...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid place-items-center p-6">
      <AuthCard title="Welcome back" variant="manus">
        {inviteId && (
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="text-right">
              <a href="/reset-password" className="text-sm text-[#898988] hover:text-[#1A1A1A] transition-colors duration-150">
                Forgot password?
              </a>
            </div>
          </div>
          ...
          <div className="relative flex items-center py-4">
            ...
            <span className="flex-shrink mx-4 text-[14px] text-[#898988]">OR</span>
            <div className="flex-grow border-t border-[rgba(0,0,0,0.08)]"></div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-[rgba(0,0,0,0.08)] rounded-[10px] bg-white hover:bg-[#F8F8F7] transition-all duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] font-medium text-[#1A1A1A] text-[14px]"
          >
