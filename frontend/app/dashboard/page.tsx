...
import { useCreateScrapeJob, useScrapeJobs, useScrapeJob, downloadScrapeResults } from "@/hooks/api/useScrape";
import { toast } from "sonner";
import { Upload, Loader2, Download, CheckCircle, Clock, AlertCircle, ArrowLeft } from "lucide-react";
            ...
            {activeJob.items && activeJob.items.length > 0 && (
              <Card>
                <CardHeader className="border-b">
                  ...
                  <CardDescription>
                    Showing first {Math.min(activeJob.items.length, 50)} of {activeJob.items.length} results
                  </CardDescription>
                </CardHeader>
                <CardContent className="pt-4">
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {activeJob.items.slice(0, 50).map((item, index) => {
