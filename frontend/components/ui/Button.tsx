  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Exa.ai style variants
        exaPrimary:
          "bg-[#111827] text-white shadow-md hover:bg-[#1f2937] hover:shadow-lg hover:-translate-y-0.5",
        exaSecondary:
          "border-2 border-[#00FF00] text-[#00FF00] bg-transparent hover:bg-[#00FF00]/10",
        exaGhost:
          "text-foreground hover:bg-[#FFFF00]/20 hover:text-[#111827]",
        // Manus.im style variant
        manus:
          "bg-[#898988] text-white hover:bg-[#707070] rounded-[10px]",
      },
      size: {
