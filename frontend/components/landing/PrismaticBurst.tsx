...
void main(){
    ...
    for (int i = 0; i < 44; ++i) {
      ...
      Pl = hoverMat * Pl;
        ...
        // Pure orange/red fallback - absolutely no green
        float warmT = marchT * 1.5;
        vec3 spectralDefault = vec3(
            1.8 + 0.2 * sin(warmT),        // R: strong 1.6-2.0
            0.4 + 0.15 * sin(warmT + 0.5), // G: weak 0.25-0.55 (much less than R)
            0.2 + 0.1 * sin(warmT + 1.0)   // B: very weak 0.1-0.3
        );
